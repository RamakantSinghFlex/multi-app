      ...
      <div className="w-full space-y-12" data-aos="fade-up" data-aos-duration="1200">
        ...
        <div className="text-black grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.supportOptions.map((option: any) => (
            <div className="bg-white rounded-lg border border-gray-200 flex items-start" key={option.id}>
              <div className="h-full w-24 bg-[#EAF4ED] flex items-center justify-center flex-shrink-0">
                <Image src={option.icon.url} alt={option.icon.alt} width={52} height={52} />
              </div>
              <div className="p-6">
