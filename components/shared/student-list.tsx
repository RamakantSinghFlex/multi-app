...
export default function StudentList({ userRole, className = "" }: StudentListProps) {
  const { user } = useAuth()
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground text-xs">
              {userRole === "tutor" ? "Manage your students" : "Manage your children's profiles"}
            </p>
          </div>
          <Button asChild size="sm">
            <Link href={`/${userRole}/students/new`}>
              ...
              <div className="flex items-center gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    {userRole === "tutor" && <DropdownMenuItem>Family</DropdownMenuItem>}
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="hover:bg-transparent">
                      ...
                      {userRole === "tutor" && <TableHead className="h-8 text-xs font-medium">Family</TableHead>}
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                  <Link href={`/${userRole}/students/${student.id}`}>View Profile</Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem asChild>
                                  <Link href={`/${userRole}/students/${student.id}/edit`}>Edit</Link>
                                </DropdownMenuItem>
                                {userRole === "tutor" && <DropdownMenuItem>Message</DropdownMenuItem>}
