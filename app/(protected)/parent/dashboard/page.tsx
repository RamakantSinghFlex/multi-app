          ...
          {showPaymentBanner && (
            <div className="bg-[#E5E5E5] rounded-lg p-4 relative">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="font-medium text-xl text-[#333333]">Payment Due</h2>
                  <p className="text-[#777777] mt-1">Your Payment is Approaching.</p>
                </div>
                <Button
                  size="lg"
                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-left border-b">
                      <th className="pb-2 font-medium text-sm text-muted-foreground w-24">Date</th>
                      <th className="pb-2 font-medium text-sm text-muted-foreground">Note Summary</th>
                      <th className="pb-2 font-medium text-sm text-muted-foreground w-28">Tutor</th>
        ...
        <div className={isMobile ? "col-span-2 space-y-6" : "space-y-6"}>
          ...
          <Card className="border border-[#efefef]">
            <CardContent className="p-4">
              ...
              <div className="mt-8">
                <h3 className="font-medium text-sm mb-3">Today&apos;s lessons</h3>

                {/* Math Class */}
                <div className="mb-4">
                  <div className="flex items-start gap-3">
                    <div className="text-xs font-medium w-12 pt-1 text-center">4:30 PM</div>
                    <div className="mx-3 h-full">
                      <Separator orientation="vertical" className="h-full min-h-[40px]" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-medium">Otis&apos;s Math Class</h4>
                ...
                <div className="mb-4">
                  <div className="flex items-start gap-3">
                    <div className="text-xs font-medium w-12 pt-1 text-center">6:30 PM</div>
                    <div className="mx-3 h-full">
                      <Separator orientation="vertical" className="h-full min-h-[40px]" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-medium">Otis&apos;s Social Science Class</h4>
                      <p className="text-xs text-muted-foreground">with Ms. Jen</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card className="border border-[#efefef]">
            <CardHeader className="pb-2 flex flex-row justify-between items-center">
              <CardTitle className="text-lg font-medium truncate">Upcoming Test</CardTitle>
              <Button size="sm" className="bg-[#0B4A3F] text-white hover:bg-[#0B4A3F]/90 rounded-full px-6">
                Schedule Session
              </Button>
            </CardHeader>
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="flex flex-col items-center justify-center bg-[#E5E5E5] h-16 w-16 rounded-lg text-center overflow-hidden">
                    ...
                    <span className="uppercase text-[#555555] text-xs">APR</span>
                  </div>
                </div>
                <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="flex flex-col items-center justify-center bg-[#E5E5E5] h-16 w-16 rounded-lg text-center overflow-hidden">
                    ...
                    <span className="uppercase text-[#555555] text-xs">MAY</span>
                  </div>
                </div>
                <div className="flex-1">
          ...
          <Card className="border border-[#efefef]">
            ...
            <CardContent className="space-y-5">
              ...
              <div className="bg-white rounded-lg border p-4">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden">
                    <Image src="/placeholder.svg?height=40&width=40&text=MJ" alt="Mark Jason" width={40} height={40} />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex">
                    <Button variant="ghost" size="icon" className="text-muted-foreground rounded-full">
                      <Image src={scheduleIcon} alt="Schedule" width={16} height={16} />
                    </Button>
                    <Button variant="ghost" size="icon" className="text-muted-foreground rounded-full">
              ...
              <div className="bg-white rounded-lg border p-4">
                <div className="flex items-center gap-3 mb-3">
                  <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden">
                    <Image src="/placeholder.svg?height=40&width=40&text=D" alt="Devon" width={40} height={40} />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
