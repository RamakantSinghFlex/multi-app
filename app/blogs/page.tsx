// filepath: c:\Users\HP\Desktop\Start-Up\Flexforce2\multi-app\app\blogs\page.tsx
...
export default async function BlogsPage() {
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="text-center mb-12">        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-green-900 mb-4">
