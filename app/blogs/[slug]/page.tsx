...
/**
 * Format blog content from markdown-like syntax to HTML
 */
function formatBlogContent(content: string): string {
  ...
  let formattedContent = content
    ...
    // Handle italics
    .replace(/\*(.*?)\*/g, "<em>$1</em>")
    // Handle headers (must come before paragraph processing)
    .replace(/^## (.*?)$/gm, "</p><h2>$1</h2><p>")
    .replace(/^# (.*?)$/gm, "</p><h1>$1</h1><p>")
    // Handle links with syntax [text](url)
    .replace(
      /\[(.*?)\]\((.*?)\)/g,
  ...
  // Clean up duplicate paragraph tags and fix header paragraphs
    ...
    <div className="container mx-auto py-10 px-4 max-w-5xl">
      ...
      <div className="mt-16 pt-8 border-t border-gray-200">
        <div className="bg-green-50 p-6 rounded-lg">
          ...
          <p className="mb-6">
            Schedule a consultation with our academic experts to discuss your
